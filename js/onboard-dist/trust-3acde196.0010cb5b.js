parcelRequire = function(e, r, t, n) {
                    ...
                    var e = n(regeneratorRuntime.mark(function e(r) {
                        ...
                        return regeneratorRuntime.wrap(function(e) {
                            for (; ; )
                                ...
                                case 0:
                                    if (t = r.getProviderName,
                                    o = r.getAddress,
                                    a = r.getNetwork,
                                    i = r.getBalance,
                                    u = window.ethereum || window.web3 && window.web3.currentProvider,
                                    !(s = "Trust" === t(u)) || !c) {
                                        e.next = 7;
                                        break
                                    }
                                    return e.next = 6,
                                    require("_bundle_loader")(require.resolve("./providerEngine-7945c13d.js"));
                                case 6:
                                    l = e.sent.default;
                                case 7:
                                    return d = l ? l({
                                                        ...
                                                        return regeneratorRuntime.wrap(function(e) {
                                                            for (; ; )
                                                                ...
                                                                case 0:
                                                                    ...
                                                                    return p || (console.warn('The Trust provider does not allow rpc calls preventing Onboard.js from getting the balance. You can pass in a "rpcUrl" to the Trust wallet initialization object to get the balance.'),
                                                                    p = !0),
    ...
    , {
        ...
        "_bundle_loader": "fiHL",
        "./providerEngine-7945c13d.js": [["providerEngine-7945c13d.01157afe.js", "ihoK"], "ihoK"]
    }],
