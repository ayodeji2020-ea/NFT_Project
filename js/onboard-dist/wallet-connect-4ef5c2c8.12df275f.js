parcelRequire = function(e, r, t, n) {
                    ...
                    var e = r(regeneratorRuntime.mark(function e(n) {
                        ...
                        return regeneratorRuntime.wrap(function(e) {
                            for (; ; )
                                ...
                                case 2:
                                    return t = e.sent.default,
                                    e.next = 5,
                                    require("_bundle_loader")(require.resolve("@walletconnect/web3-provider"));
                                case 5:
                                    if (i = e.sent,
                                    u = i.default,
                                    l = n.resetWalletState,
                                    s = n.networkName,
                                    p = n.getBalance,
                                    h = o && o[d] ? o[d] : "https://".concat(s(d), ".infura.io/v3/").concat(c),
                                    v = t({
                                        rpcUrl: h
                                    }),
                                    !c || !o) {
    ...
    , {
        ...
        "@walletconnect/web3-provider": [["esm.439ef28d.js", "IGDU"], "IGDU"]
    }],
